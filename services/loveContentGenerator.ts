...
const GENRE_HASHTAGS: Record<Genre, string[]> = {
  // 検索ボリューム・保存率・拡散率を最大化するバズ特化タグ構成
  // 大タグ（拡散）＋中タグ（刺さる）＋感情タグ（共感・保存）の3層構成
  '恋愛': [
    '#恋愛', '#恋愛相談', '#恋愛心理学', '#男性心理', '#片思い',
    '#好きな人', '#LINEあるある', '#恋愛あるある', '#モテ期', '#彼氏彼女',
    '#恋愛成就', '#復縁', '#マッチングアプリ', '#婚活', '#脈あり診断',
  ],
  'お金・資産': [
    '#お金の話', '#節約術', '#投資初心者', '#NISA', '#資産運用',
    '#貯金術', '#お金の知識', '#副収入', '#月収UP', '#経済的自由',
    '#お金の勉強', '#FIREを目指す', '#節約生活', '#家計管理', '#ポイ活',
  ],
  '副業・稼ぐ': [
    '#副業', '#副業初心者', '#SNS副業', '#TikTok収益化', '#在宅ワーク',
    '#フリーランス', '#コンテンツ販売', '#月5万', '#稼ぐ方法', '#副業収入',
    '#在宅副業', '#note収益', '#SNS運用', '#個人事業主', '#脱サラ',
  ],
  '美容・ダイエット': [
    '#ダイエット', '#痩せた', '#スキンケア', '#美肌', '#ダイエット記録',
    '#美容', '#プチプラコスメ', '#むくみ解消', '#糖質制限', '#ながら運動',
    '#マイナス何キロ', '#ファスティング', '#美容オタク', '#垢抜け', '#美容習慣',
  ],
  '育児・子育て': [
    '#育児', '#子育て', '#ママ', '#イヤイヤ期', '#寝かしつけ',
    '#育児あるある', '#子育てあるある', '#育児日記', '#ワンオペ育児', '#産後ケア',
    '#知育', '#離乳食', '#3歳', '#育児疲れ', '#子どもとの時間',
  ],
  '健康・メンタル': [
    '#メンタルヘルス', '#自律神経', '#睡眠の質', '#ストレス解消', '#腸活',
    '#マインドフルネス', '#うつ予防', '#疲れない体', '#健康習慣', '#メンタルケア',
    '#血糖値', '#免疫力UP', '#デジタルデトックス', '#自己肯定感', '#心が楽になる',
  ],
  '転職・キャリア': [
    '#転職', '#転職活動', '#年収UP', '#転職成功', '#仕事術',
    '#キャリアアップ', '#面接対策', '#副業から独立', '#AI仕事術', '#フリーランス転向',
    '#働き方改革', '#リモートワーク', '#昇給交渉', '#スキルアップ', '#仕事辞めたい',
  ],
  '人間関係': [
    '#人間関係', '#自己肯定感', '#HSP', '#コミュ力', '#毒親',
    '#職場の人間関係', '#断り方', '#人付き合い', '#ストレス発散', '#人間関係リセット',
    '#ママ友', '#義実家', '#友達いない', '#コミュ障克服', '#人たらし術',
  ],
  'ビジネス・起業': [
    '#起業', '#SNS運用', '#個人ブランディング', '#集客', '#マーケティング',
    '#ChatGPT活用', '#Canva', '#コンテンツマーケ', '#起業家', '#LINE公式',
    '#SNSマーケ', '#ビジネス思考', '#価格設定', '#ストーリーズ', '#脱サラ起業',
  ],
  'ライフスタイル': [
    '#ミニマリスト', '#朝活', '#習慣化', '#ライフハック', '#読書好き',
    '#手帳術', '#一人暮らし', '#おうち時間', '#サウナ', '#旅行好き',
    '#シンプルライフ', '#丁寧な暮らし', '#自分磨き', '#ルーティン', '#暮らしの工夫',
  ],
};
